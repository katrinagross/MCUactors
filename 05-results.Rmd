...
PC2_data %>%
  parcoords(rownames= FALSE, brushMode = "1D-axes", reorderable = TRUE, queue = TRUE, alpha= .5, color= list(colorBy = "joining_phase", colorScale= "scaleOrdinal", colorScheme= c(colors[4], colors[2], colors[11], colors[6])), withD3 = TRUE, width = 1100, height= 400
            )
```
